...
class Config:
    ...
    def get_sourcegraph_endpoint(self) -> str:
        ...
        return self.get(
            "sourcegraph.endpoint", "https://sourcegraph.example.com/.api/graphql"
        )
